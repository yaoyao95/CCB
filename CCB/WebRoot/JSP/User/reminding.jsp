  	...
  	<div class="main">
  		...
  		<div class="middle" style="width: 90%" align="center">
			...
			<div style="margin-top: -10px;">
				<s:form action="toReminding" namespace="/user" method="post"
						theme="simple">
					<span>发出@提醒的用户</span><s:textfield name="rdc.remindingUserName" />&nbsp;&nbsp;
			...
			<div  style="border:1px solid #DDDDFF;border-right:1px solid #DDDDFF; height: auto; width: 90%; ">
				...
				<table class="thread1" cellspacing="0" cellpadding="0" width="100%">
					...
					<s:iterator value="remindings" status="count">
						<tr>
						    <td>
							...
							<td>
								<s:if test="theRemindedPostReply == null">
									<s:if test="theRemindedPostTheme != null">
										主题帖
									</s:if>
								</s:if>
								<s:if test="theRemindedPostReply != null">
							...
							<td style="text-align: left;padding-left: 10px;">
							    <s:a href="%{href}">
							    	<s:property value="theRemindedPostTheme.title"/>
							    	<s:if test="theRemindedPostReply != null">
							    		&nbsp;&nbsp;<s:property value="theRemindedPostReply.storey"/>楼
							    	</s:if>
							    </s:a>
							</td> 
							<td style="color:red;">
								<s:if test="remindingUserName == 'visitors'">
									游客
								</s:if>
								<s:else>
									<s:property value="remindingUserName"/>
								</s:else>
							</td>
							<td>
							    <s:if test="isRead == 0">
				...
				<my_p:pager pageIndex="${pageModel.pageIndex}"
					...
					submitUrl="user/toReminding?pageModel.pageIndex={0}&pageModel.pageSize=${pageModel.pageSize}" />
			</div>
  		</div>
  		<div class="top">
  		</div>
